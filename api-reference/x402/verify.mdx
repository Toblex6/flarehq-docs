...
description: "Fetch your x402 USDC earnings, withdraw accumulated funds to any wallet, or verify a buyer's payment proof server-side via the /api/x402 endpoints."
---
...
All three endpoints require a merchant API key in the `x-api-key` header.

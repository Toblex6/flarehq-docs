...
<Note>
  This endpoint requires a merchant API key. You can generate one in the FlareHQ dashboard under **Settings → API Keys**.
</Note>
...
|---|---|---|
| `x-api-key` | Yes | `fhq_sec_...` — your merchant API key |

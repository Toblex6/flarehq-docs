---
title: "List Active Payment Streams — GET /api/payments/stream"
sidebarTitle: "List Streams"
description: "GET /api/payments/stream — returns all USDC payment streams with real-time balance calculations. Filter by sender, receiver, status, or reference."
---

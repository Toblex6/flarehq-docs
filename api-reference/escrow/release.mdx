---
title: "Release Locked Escrow Funds — POST /api/escrow/release"
sidebarTitle: "Release Escrow"
description: "POST /api/escrow/release — releases locked USDC to the beneficiary once both parties confirm. Returns txHash and release status."
---

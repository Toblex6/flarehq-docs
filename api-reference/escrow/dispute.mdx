---
title: "Raise a Dispute on Escrow — POST /api/escrow/dispute"
sidebarTitle: "Dispute Escrow"
description: "POST /api/escrow/dispute — raises a dispute on an active escrow, locking it until FlareHQ resolves the disagreement. Returns txHash and updated status."
---

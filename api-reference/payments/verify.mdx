---
title: "GET /api/payments/verify — Check Payment Status"
sidebarTitle: "Verify Payment"
description: "GET /api/payments/verify/{reference} — returns the current status, amount, and on-chain txHash of a USDC payment session."
---

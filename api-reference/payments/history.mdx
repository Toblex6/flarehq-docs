---
title: "USDC Payment History — GET /api/payments/history"
sidebarTitle: "Payment History"
description: "GET /api/payments/history — paginated list of USDC payment records for your merchant account. Filter by status, date range, and page size."
---
...
| Header | Value |
|---|---|
| `x-api-key` | `fhq_sec_...` — required (merchant API key) |
...
<ResponseField name="transactions" type="array">
  ...
  <Expandable title="transaction object fields">
    ...
    <ResponseField name="transactions[].senderEmail" type="string">
      Email address or wallet address of the payer. Agent-originated payments show `"autonomous-agent@arc.network"`.
    </ResponseField>

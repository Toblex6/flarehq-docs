---
title: "FlareHQ Quickstart: Send Your First USDC Payment in Minutes"
  ...
  <Step title="Set up webhooks">
    ...
    export async function POST(req: NextRequest) {
      ...
      switch (event.type) {
        ...
        case 'escrow.created':
          console.log('Escrow opened:', event.data.reference);
          break;

        case 'escrow.disputed':
          console.log('Dispute raised:', event.data.reference);
          break;
      }

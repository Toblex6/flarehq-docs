---
title: "FlareHQ: Web3 Payment Infrastructure for Builders"
...
<CardGroup cols={2}>
  ...
  <Card title="Cross-Chain USDC Bridge" icon="arrow-right-arrow-left" href="/api-reference/overview">
...
| **Registry** | ERC-8004 Identity | Agent identity registry at `0x3500...8004` — every deployed agent gets a unique on-chain ID and token |

---
title: "Add an x402 Paywall to Any API Endpoint"
...
To test a successful paid request, use the FlareHQ SDK or the `POST /api/x402/pay` endpoint to attach a valid proof:
...
curl -X POST https://flarehq.xyz/api/x402/pay \
  ...
  -d '{
    "resourceUrl": "https://your-api.example.com/api/v1/premium-data",

---
title: "FlareHQ x402 Marketplace: Publish and Monetize APIs"
...
<Steps>
  ...
  <Step title="Update pricing or toggle status">
    ...
    | Value | Effect |
    |---|---|
    | `DRAFT` | Listing is saved but not visible to consumers |
    | `PUBLISHED` | Listing is live and accepts paid requests |
    | `SUSPENDED` | Listing is hidden from the directory and returns `404` to consumers |
  </Step>
